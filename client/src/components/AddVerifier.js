        ...
        return (
          <div className = "container-fluid">
            ...
            <div className = "container"> 
              <div className="row">
                <div className="col-*-*"><h3>Ingresa los datos de{this.state.type == "?university" ? " la institución académica": "l empleador"}</h3></div>
              </div>
              <div className="row">
                <Form onSubmit={(event) => {
                  ...
                  <FormGroup>
                    ...
                    <FormControl
                        ...
                        onChange = {this.handleInputChange}
                        placeholder = "Introduce la dirección postal del verificador"
                        required />
                  </FormGroup> 
                  ...
                  <FormGroup>
                    ...
                    <FormControl
                        ...
                        onChange = {this.handleInputChange}
                        placeholder = "Introduce la dirección Ethereum del verificador" />
                  </FormGroup>
